...
var _imageZoom = __webpack_require__(64);
	...
	_createClass(Demo, [{
		...
		value: function render() {
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement('div', { className: 'container', ref: 'container' }),
				_react2.default.createElement(
					'div',
					null,
					_react2.default.createElement('img', { src: this.state.url, width: '50', height: '50', alt: '' })
				)
			);
		}
		// 组件创建完成
		...
		value: function componentDidMount() {
			// 使用插件
			new _imageZoom2.default(this.refs.container, this.state.url, this.state.width);
		}
	}]);
