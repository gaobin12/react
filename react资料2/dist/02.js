...
var Gotop = function (_Component) {
	...
	function Gotop(props) {
		...
		console.log(2, 'constructor', props, _this.props, _this.state);
		// 初始化
		_this.state = {
			text: props.title
		};
	...
	_createClass(Gotop, [{
		...
		value: function componentWillMount() {
			console.log(3, 'componentWillMount', this.props, this.state, (0, _reactDom.findDOMNode)(this));
		}
		// 4 渲染虚拟DOM
		...
		value: function componentDidMount() {
			console.log(5, 'componentDidMount', this.props, this.state, (0, _reactDom.findDOMNode)(this));
		}
	}]);
...
Gotop.defaultProps = {
	...
	// 渲染组件
};(0, _reactDom.render)(_react2.default.createElement(Gotop, null), app);
