	...
	_createClass(Child, [{
		...
		value: function render() {
			...
			return _react2.default.createElement('input', { type: 'text', onChange: function onChange(e) {
					return _this2.props.methods(e.target.value);
				} });
		}
	}]);
...
var Other = function (_Component2) {
	_inherits(Other, _Component2);
...
var Parent = function (_Component3) {
	_inherits(Parent, _Component3);
	...
	_createClass(Parent, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement(Child, { methods: function methods(msg) {
						return _this5.setState({ msg: msg });
					} }),
