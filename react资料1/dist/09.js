...
var Demo = function (_Component) {
	...
	_createClass(Demo, [{
		...
		value: function createList() {
			...
			return this.props.data.map(function (item, index) {
				return _react2.default.createElement(
					...
					{ key: index, style: {
							// 显示第num个
							display: _this2.state.num % len === index ? 'block' : 'none'
						} },
					_this2.createChildrenList(item)
				);
			});
		}
		// 渲染字列表
		...
		value: function createChildrenList(item) {
			// 遍历参数数据，并返回视图结果
...
(0, _reactDom.render)(_react2.default.createElement(Demo, { data: [['人民币中间价上调', '双11消费提示'], ['货车与火车相撞', '石智勇破世界纪录'], ['日本大型无人潜艇', '陈妍希拍婚纱照']] }), app);

(0, _reactDom.render)(_react2.default.createElement(Demo, { data: [['海上聚众黄赌毒'], ['最严遛狗规定'], ['苹果新机砍单']] }), app2);
