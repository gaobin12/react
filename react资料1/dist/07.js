...
Nav.defaultProps = {
	...
	// 渲染
};(0, _reactDom.render)(_react2.default.createElement(Nav, { num: 100, data: ['教你理财', '天猫购物季', '热门房源'] }), app);
// 渲染第二组导航
(0, _reactDom.render)(_react2.default.createElement(Nav, { num: 0, data: ['天猫', '当当网', '1号店'] }), app2);
// 渲染第三组导航
(0, _reactDom.render)(_react2.default.createElement(Nav, { num: 20 }), app3);
